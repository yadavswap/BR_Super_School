...
<nav class="site-nav mb-5">
    ...
    {{-- <a href="#" class="btn-book btn btn-primary btn-sm menu-absolute">Join BRHS</a> --}}
    ...
    <div class="untree_co-hero overlay" style="background-image: url('images/int.JPG');">
        <div class="container">
        <div class="row align-items-center justify-content-center">
        <div class="col-12">
        <div class="row justify-content-center">
        <div class="col-lg-7 text-center text-lg-center">
        <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">New Initiatives</h1>
        ...
        <h2 class="line-bottom text-center mb-4">New Initiatives</h2>
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 " data-aos="fade-up" data-aos-delay="100">
        <div class="staff ">
        {{-- <div class="mb-4"><img src="images/staff_2.jpg" alt="Image" class="img-fluid"></div> --}}
        <div >
            <p class="demo">
            School committee has taken many Initiatives for the all-round development of the leaners.These
            initiatives improve the quality of education and sports<br><br>


            Summer camp : our school conducts summer camp for the students in summer holidays with the help of
            Suryodaya Krida Prabhodini.The sport Teacher Mr.Dhiraj Dhole has been arranging such camps for 11
            years on the school ground.all types of sports like Kho Kho, volleyball ,mallakhamb ,Archery, Boxing,
            Wresting etc. The camp focusses not only on sport but conducting many cultural programme (drama,
            dance etc.)<br><br>


            Test Series: School has started its own test series for the Board exam appeared students in HSC and SSC .
            Near about 600 students appear in the test series which is conducted in holidays with the help of
            teaching staff. It is taken in 3 rounds. This started 10 years before and proved very successful and results
            improved.<br><br>


            Extra classes in Summer Vacation: the teachers toil hard for the betterment of the students. In summer
            vacation teachers put extra efforts by taking extra classes which helps to improve the results in board
            exam.  
            </p>
            ...
            <li>Shri. Trilokchandji Khona - (25.06.1954 to 12.08.1972)</li>
