...
<nav class="site-nav mb-5">
    ...
    <div class="untree_co-hero overlay" style="background-image: url('images/lib.jpeg');">
        <div class="container">
        <div class="row align-items-center justify-content-center">
        <div class="col-12">
        <div class="row justify-content-center">
        <div class="col-lg-7 text-center text-lg-center">
        <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Online Books</h1>
        ...
        <h2 class="line-bottom text-center mb-4">Online Books</h2>
        ...
        <div >
           ...
           <ul>
                <a href="/files/library.pdf" target="_blank"><li> ग्रंथालय विभाग
                </li></a>

               <a href="/lib/1.pdf" target="_blank"><li>13 Steps To Bloody Good </li></a>
               <a href="/lib/2.pdf" target="_blank"><li>13 Steps to Bloody Good Marks </li></a>
               <a href="/lib/3.pdf" target="_blank"><li>2107 Curious Word Origins, Sayings and Expressions </li></a>
               <a href="/lib/4.pdf" target="_blank"><li>Common_Mistakes_in_English</li></a>
               <a href="/lib/6.pdf" target="_blank"><li>Oxford-Thesaurus-An-a-Z-Dictionary-of-Synonyms.pdf</li></a>
               <a href="/files/All_Lib.pdf" target="_blank"><li>Click here to all records of library. </li></a>
